...
class CustomUserAdmin(admin.ModelAdmin):
    list_display = ('profile_picture_thumbnail','username', 'first_name', 'last_name', 'email', 'phone_number', 'age', 'gender','bio','latitude','longitude','role','specialization','is_approved','is_active','bonus_points', 'date_joined')
